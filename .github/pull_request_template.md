...
don't apply. The CI workflow (build + 244+ tests + mock-run smoke on Windows) must pass
before merge.
-->
...
- [ ] `dotnet test --project tests/WingetTuiSharp.Tests.csproj` — all 244+ tests pass
